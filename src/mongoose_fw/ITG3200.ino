...
void Init_Gyro()
{
  ...
  Wire.write(0);  // Sample rate divider is 1 (register value + 1)
  ...
  Wire.write( (0x03<<3) | (0x00<<0) );  // Set the full-scale range to +/- 2000deg/sec, and the low pass filter to 256Hz
  Wire.endTransmission();
  delay(20);	
