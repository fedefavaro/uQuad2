...
/*int uquad_mat_fill(struct uquad_mat *m, double val)*/
/*{*/
/*    int*/
/*	len,*/
/*	i;*/
...
int uquad_mat_get_subm(struct uquad_mat *S, int r, int c, struct uquad_mat *A)
{
/*    if(S == NULL || A == NULL)*/
/*    {*/
/*	err_check(ERROR_NULL_POINTER,"NULL pointer is invalid arg.");*/
...
/*int uquad_mat_set_subm(struct uquad_mat *A, int r, int c, struct uquad_mat *S)*/
/*{*/
/*    if(A == NULL || S == NULL)*/
/*    {*/
/*	err_check(ERROR_NULL_POINTER,"NULL pointer is invalid arg.");*/
...
int uquad_mat_copy(struct uquad_mat *dest, struct uquad_mat *src)
{
...
/*int uquad_mat_diag(struct uquad_mat *m, double *diag)*/
/*{*/
/*    int retval;*/
/*    if(m == NULL)*/
/*    {*/
...
/*int uquad_mat_get_diag(double v[],struct uquad_mat *m,int n)*/
/*{*/
/*    if(m == NULL)*/
/*    {*/
...
/*int struct uquad_matranspose_inplace(struct uquad_mat *m)*/
/*{*/
/*    if(m == NULL)*/
/*    {*/
/*	err_check(ERROR_NULL_POINTER, "Cannot load, must allocate memory previously.");*/
...
/*    int i=1;*/
/*    struct uquad_mat *aux0 = NULL;*/
/*    struct uquad_mat *aux1 = NULL;*/
/*    struct uquad_mat *aux2 = NULL;*/
/*    double factor=1;*/
/*    int n=A->r;*/
/*    double norm = 1;*/
/*    */
...
/*		     struct uquad_mat *Vr, struct uquad_mat *V,*/
...
/*int uquad_mat_load(struct uquad_mat *m, FILE *input)*/
/*{*/
/*    int i;*/
/*    double dtmp;*/
/*    if(m == NULL)*/
...
/*void uquad_mat_dump(struct uquad_mat *m, FILE *output)*/
/*{*/
/*    int i,j;*/
/*    if(m == NULL)*/
/*    {*/
...
/*void uquad_mat_dump_vec(struct uquad_mat *m, FILE *output, uquad_bool_t tight)*/
/*{*/
/*    int i,len;*/
/*    if(m == NULL)*/
/*    {*/
...
struct uquad_mat *uquad_mat_alloc(int r, int c)
{
    int i;
    ...
    struct uquad_mat *m;
    m = (struct uquad_mat *)malloc(sizeof(struct uquad_mat));
    mem_alloc_check(m);
    m->r = r;
    m->c = c;
...
void uquad_mat_free(struct uquad_mat *m)
{
    if(m == NULL)
	return;
    free(m->m_full);
